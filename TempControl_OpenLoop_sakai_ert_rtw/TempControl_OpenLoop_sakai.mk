###########################################################################
## Makefile generated for component 'TempControl_OpenLoop_sakai'. 
## 
## Makefile     : TempControl_OpenLoop_sakai.mk
## Generated on : Fri Oct 10 13:34:48 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TempControl_OpenLoop_sakai.elf
...
PRODUCT_NAME              = TempControl_OpenLoop_sakai
MAKEFILE                  = TempControl_OpenLoop_sakai.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2025a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2025a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = G:/Meine Ablage/5.Sem_Mechatronik_Laptop/Regelungstechnik/Lab_Lukas
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = TempControl_OpenLoop_sakai_comp.rsp
CMD_FILE                  = TempControl_OpenLoop_sakai.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
EMPTY                     = 
SPACE                     = $(EMPTY) $(EMPTY)
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TempControl_OpenLoop_sakai.elf
...
DEFINES_STANDARD = -DMODEL=TempControl_OpenLoop_sakai -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/mbed/src/MW_AnalogInput.cpp C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/mbed/src/MW_PWM.cpp $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_mode.c "$(START_DIR)/TempControl_OpenLoop_sakai_ert_rtw/TempControl_OpenLoop_sakai.c" "$(START_DIR)/TempControl_OpenLoop_sakai_ert_rtw/TempControl_OpenLoop_sakai_data.c" $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_common.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_classic_trigger.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_standard.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_daq.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_calibration.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_fifo.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_transport.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default/xcp_mem_default.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default/xcp_drv_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common/xcp_utils.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_frame_serial.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_param_default_serial.c C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/stmnucleo/STM32F401RE/src/mw_mbed_interface.cpp C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/mbed/src/BufferedSerial.cpp C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/stmnucleo/src/blapp_support.c C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/mbed/src/GCC/mbed_syscalls.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/scheduler/src/SysTickScheduler.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/scheduler/src/m3m4m4f_multitasking.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/xcp/src/sys_arch.c C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/mbed/src/xcp_platform_timer_mbed.c C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/mbed/src/rtiostream_serial_mbed.cpp

MAIN_SRC = "$(START_DIR)/TempControl_OpenLoop_sakai_ert_rtw/ert_main.c"
...
OBJS = MW_AnalogInput.cpp.o MW_PWM.cpp.o xcp_ext_mode.c.o TempControl_OpenLoop_sakai.c.o TempControl_OpenLoop_sakai_data.c.o xcp_ext_common.c.o xcp_ext_classic_trigger.c.o xcp.c.o xcp_standard.c.o xcp_daq.c.o xcp_calibration.c.o xcp_fifo.c.o xcp_transport.c.o xcp_mem_default.c.o xcp_drv_rtiostream.c.o xcp_utils.c.o xcp_frame_serial.c.o xcp_ext_param_default_serial.c.o mw_mbed_interface.cpp.o BufferedSerial.cpp.o blapp_support.c.o mbed_syscalls.c.o SysTickScheduler.c.o m3m4m4f_multitasking.c.o sys_arch.c.o xcp_platform_timer_mbed.c.o rtiostream_serial_mbed.cpp.o
...
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry=Reset_Handler --specs=nano.specs --specs=nosys.specs -T"C:\ProgramData\MATLAB\SupportPackages\R2025a\toolbox\target\supportpackages\stmnucleo\registry\../mbed/NUCLEO_F401RE/TOOLCHAIN_GCC_ARM/STM32F401XE.ld" @G:\Meine Ablage\5.Sem_Mechatronik_Laptop\Regelungstechnik\Lab_Lukas\TempControl_OpenLoop_sakai_ert_rtw\mbed_objects.rsp
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(LIBS) $(MAIN_OBJ)
	...
	$(CPP_LD) $(CPP_LDFLAGS) -o $(PRODUCT) @$(CMD_FILE) $(call CONVERT_ESCAPED_SPACES_TO_QUOTES,$(LIBS)) $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
%.c.o : $(call SPACE_TO_QUESTION,$(START_DIR))/TempControl_OpenLoop_sakai_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(call SPACE_TO_QUESTION,$(START_DIR))/TempControl_OpenLoop_sakai_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.cpp.o : $(call SPACE_TO_QUESTION,$(START_DIR))/TempControl_OpenLoop_sakai_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(call SPACE_TO_QUESTION,$(START_DIR))/TempControl_OpenLoop_sakai_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(call SPACE_TO_QUESTION,$(START_DIR))/TempControl_OpenLoop_sakai_ert_rtw/%.C
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(call SPACE_TO_QUESTION,$(START_DIR))/TempControl_OpenLoop_sakai_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_AnalogInput.cpp.o : C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/mbed/src/MW_AnalogInput.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MW_PWM.cpp.o : C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/mbed/src/MW_PWM.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
TempControl_OpenLoop_sakai.c.o : $(call ESCAPE_SPACES,$(START_DIR))/TempControl_OpenLoop_sakai_ert_rtw/TempControl_OpenLoop_sakai.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TempControl_OpenLoop_sakai_data.c.o : $(call ESCAPE_SPACES,$(START_DIR))/TempControl_OpenLoop_sakai_ert_rtw/TempControl_OpenLoop_sakai_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.c.o : $(call ESCAPE_SPACES,$(START_DIR))/TempControl_OpenLoop_sakai_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
mw_mbed_interface.cpp.o : C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/stmnucleo/STM32F401RE/src/mw_mbed_interface.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


BufferedSerial.cpp.o : C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/mbed/src/BufferedSerial.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


blapp_support.c.o : C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/stmnucleo/src/blapp_support.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mbed_syscalls.c.o : C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/mbed/src/GCC/mbed_syscalls.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
sys_arch.c.o : $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/xcp/src/sys_arch.c
	$(CC) $(CFLAGS) -o "$@" "$<"


xcp_platform_timer_mbed.c.o : C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/mbed/src/xcp_platform_timer_mbed.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtiostream_serial_mbed.cpp.o : C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/mbed/src/rtiostream_serial_mbed.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
