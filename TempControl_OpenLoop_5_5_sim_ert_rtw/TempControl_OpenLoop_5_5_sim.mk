###########################################################################
## Makefile generated for component 'TempControl_OpenLoop_5_5_sim'. 
## 
## Makefile     : TempControl_OpenLoop_5_5_sim.mk
## Generated on : Sat Oct 18 18:01:02 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TempControl_OpenLoop_5_5_sim.elf
...
PRODUCT_NAME              = TempControl_OpenLoop_5_5_sim
MAKEFILE                  = TempControl_OpenLoop_5_5_sim.mk
...
COMPILER_COMMAND_FILE     = TempControl_OpenLoop_5_5_sim_comp.rsp
CMD_FILE                  = TempControl_OpenLoop_5_5_sim.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TempControl_OpenLoop_5_5_sim.elf
...
DEFINES_STANDARD = -DMODEL=TempControl_OpenLoop_5_5_sim -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/TempControl_OpenLoop_5_5_sim_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/TempControl_OpenLoop_5_5_sim_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.cpp.o : $(START_DIR)/TempControl_OpenLoop_5_5_sim_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/TempControl_OpenLoop_5_5_sim_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/TempControl_OpenLoop_5_5_sim_ert_rtw/%.C
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/TempControl_OpenLoop_5_5_sim_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
TempControl_OpenLoop_5_5_sim.c.o : $(START_DIR)/TempControl_OpenLoop_5_5_sim_ert_rtw/TempControl_OpenLoop_5_5_sim.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TempControl_OpenLoop_5_5_sim_data.c.o : $(START_DIR)/TempControl_OpenLoop_5_5_sim_ert_rtw/TempControl_OpenLoop_5_5_sim_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.c.o : $(START_DIR)/TempControl_OpenLoop_5_5_sim_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
