###########################################################################
## Makefile generated for component 'TempControl_OpenLoop_5_3'. 
## 
## Makefile     : TempControl_OpenLoop_5_3.mk
## Generated on : Fri Oct 17 15:45:25 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TempControl_OpenLoop_5_3.elf
...
PRODUCT_NAME              = TempControl_OpenLoop_5_3
MAKEFILE                  = TempControl_OpenLoop_5_3.mk
...
COMPILER_COMMAND_FILE     = TempControl_OpenLoop_5_3_comp.rsp
CMD_FILE                  = TempControl_OpenLoop_5_3.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TempControl_OpenLoop_5_3.elf
...
DEFINES_STANDARD = -DMODEL=TempControl_OpenLoop_5_3 -DNUMST=3 -DNCSTATES=1 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/TempControl_OpenLoop_5_3_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/TempControl_OpenLoop_5_3_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.cpp.o : $(START_DIR)/TempControl_OpenLoop_5_3_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/TempControl_OpenLoop_5_3_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/TempControl_OpenLoop_5_3_ert_rtw/%.C
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/TempControl_OpenLoop_5_3_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
TempControl_OpenLoop_5_3.c.o : $(START_DIR)/TempControl_OpenLoop_5_3_ert_rtw/TempControl_OpenLoop_5_3.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TempControl_OpenLoop_5_3_data.c.o : $(START_DIR)/TempControl_OpenLoop_5_3_ert_rtw/TempControl_OpenLoop_5_3_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.c.o : $(START_DIR)/TempControl_OpenLoop_5_3_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
